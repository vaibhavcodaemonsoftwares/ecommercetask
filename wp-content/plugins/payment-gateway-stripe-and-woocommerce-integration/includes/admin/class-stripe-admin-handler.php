...
class Eh_Stripe_Admin_Handler  {
    ...
    function eh_stripe_menu_page(){
        ...
        <div class="wrap">
            ...
            $arr_local_gateways = array('local', 'alipay', 'sepa', 'klarna', 'afterpay', 'wechat', 'sofort', 'ideal', 'bancontact', 'eps', 'p24', 'giropay', 'bacs', 'becs', 'fpx', 'boleto', 'oxxo', 'grabpay', 'multibanco');
            ?>
                ...
                <?php
                    ...
                    if($tab == 'local' || $tab == 'alipay' || $tab == 'sepa' || $tab == 'klarna' || $tab == 'afterpay' || $tab == 'wechat' || $tab == 'sofort' || $tab == 'ideal'){
    ...
    public function eh_local_gateways(){
        ...
        ?><ul class="eh-advanced-settings-nav local-gateways">
                ...
                <li id="eh-li-local"><a <?php ($clicked_tab == 'multibanco') ? print('style="color:#9c9696"') : '' ?>   id="eh-multibanco-link" class="nav-link"  href="?page=wt_stripe_menu&tab=multibanco"><?php _e('Multibanco', 'payment-gateway-stripe-and-woocommerce-integration') ?></a></li>        </ul><?php
